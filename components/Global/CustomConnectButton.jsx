              ...
              if (!connected) {
                return (
                  <button
                    ...
                    className={`flex items-center bg-gradient-to-r from-fuchsia-500 to to-purple-600 hover:from-fuchsia-600 hover:to-purple-700 text-white px-4 py-2 rounded-md transition-colors ${childStyle}`}
                  >
